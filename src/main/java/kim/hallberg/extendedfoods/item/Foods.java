...
public class Foods {
    public static final Food bamboo_curry = (new Food.Builder()).hunger(8).saturation(0.4F).effect(new EffectInstance(Effects.SPEED, 400, 1), 1.0F).setAlwaysEdible().build();
